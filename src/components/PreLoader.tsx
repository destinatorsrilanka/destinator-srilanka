...
export default function PreLoader() {
  ...
  useEffect(() => {
    const handleLoad = () => {
      // Animation එක සම්පූර්ණ වීමට තත්පර 4ක් පමණ ලබා දුන්නා
  ...
  return (
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          {/* සිතියම පසුබිමෙන් පෙනෙන ලෙස (සියලු Paths සහිතව) */}
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              ...
              <div className="w-48 h-[1px] bg-white/5 relative overflow-hidden mx-auto mb-8">
                <motion.div
                  initial={{ x: "-100%" }}
                  animate={{ x: "100%" }}
                  transition={{
