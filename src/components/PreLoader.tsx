        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              ...
              {/* Progress Line */}
              <div className="w-48 h-[1px] bg-white/5 relative overflow-hidden mx-auto mb-8 mt-4">
                <motion.div
                  initial={{ x: "-100%" }}
                  animate={{ x: "100%" }}
                  transition={{
